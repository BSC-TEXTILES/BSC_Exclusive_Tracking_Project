...
export const PERMISSIONS = {
  ...
  SUPERVISOR_MANAGE_TEAM: 'supervisor:manage_team',
  SUPERVISOR_REVIEW_APPROVALS: 'supervisor:review_approvals',
  SUPERVISOR_VIEW_REPORTS: 'supervisor:view_reports',
  SUPERVISOR_MANAGE_DEPARTMENTS: 'supervisor:manage_departments',
  SUPERVISOR_MANAGE_PROJECTS: 'supervisor:manage_projects',
  SUPERVISOR_VIEW_ACTIVITY: 'supervisor:view_activity',
  SUPERVISOR_ASSIGN_EMPLOYEES: 'supervisor:assign_employees',
  SUPERVISOR_REASSIGN_EMPLOYEES: 'supervisor:reassign_employees',
  SUPERVISOR_APPROVE_REQUESTS: 'supervisor:approve_requests',
  SUPERVISOR_REJECT_REQUESTS: 'supervisor:reject_requests',
  SUPERVISOR_ESCALATE_REQUESTS: 'supervisor:escalate_requests',
...
export const ROLE_PERMISSIONS: Record<string, PermissionName[]> = {
  ...
  MANAGER: [
    ...
    PERMISSIONS.SUPERVISOR_MANAGE_TEAM,
    PERMISSIONS.SUPERVISOR_REVIEW_APPROVALS,
    PERMISSIONS.SUPERVISOR_VIEW_REPORTS,
    PERMISSIONS.SUPERVISOR_MANAGE_DEPARTMENTS,
    PERMISSIONS.SUPERVISOR_MANAGE_PROJECTS,
    PERMISSIONS.SUPERVISOR_VIEW_ACTIVITY,
    PERMISSIONS.SUPERVISOR_ASSIGN_EMPLOYEES,
    PERMISSIONS.SUPERVISOR_REASSIGN_EMPLOYEES,
    PERMISSIONS.SUPERVISOR_APPROVE_REQUESTS,
    PERMISSIONS.SUPERVISOR_REJECT_REQUESTS,
    PERMISSIONS.SUPERVISOR_ESCALATE_REQUESTS,
  ],
